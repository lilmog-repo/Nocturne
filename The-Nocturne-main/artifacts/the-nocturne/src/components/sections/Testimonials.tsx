      ...
      <div className="container mx-auto px-6 md:px-12">
        ...
        <div className="flex flex-col lg:flex-row items-start lg:items-center gap-10 lg:gap-8">
          ...
          >
            ...
            <blockquote className="font-serif text-xl sm:text-2xl md:text-3xl lg:text-4xl leading-snug mb-8 md:mb-10 text-white/90">
              "Stepping into The Nocturne felt like crossing into another world. The lighting, the music, even the silence between songs — everything was perfectly tuned to the night."
            </blockquote>

            <div className="flex items-center justify-between">
              <div className="font-sans">
                <div className="text-sm font-semibold tracking-wider uppercase mb-1">Clara M.</div>
                <div className="text-xs text-white/50 tracking-wide">Design Director, New York</div>
              </div>

              <div className="flex gap-3">
                <button className="w-10 h-10 md:w-12 md:h-12 rounded-full border border-white/20 flex items-center justify-center hover:bg-white/10 transition-colors text-sm">
